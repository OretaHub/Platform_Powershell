...
V1.0 (Apr 02, 2025) - Removed beta version cmdlets 
...
Function main
{
    ...
    Write-Host `n~~ Script is working ~~`n -ForegroundColor Green
    Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "happy scripting" -ForegroundColor Yellow -NoNewline; Write-Host " to get access to 1800+ Microsoft 365 reports. ~~" -ForegroundColor Green `n`n
    Disconnect_Modules
}
. main